    ...
    <div className="w-full bg-circle-neutral flex flex-col gap-0">
      ...
      <div className="px-4 py-6">
        <div className="max-w-7xl mx-auto relative">
          {/* Contacts Title - Always Centered */}
        ...
        <div className="flex justify-center">
          <div className="flex flex-row items-center gap-5">
            ...
            <div className="flex flex-row justify-between items-center bg-white border border-circle-neutral-variant rounded-[25px] w-[560px] h-[30px] px-1.5">
              <div className="flex flex-row justify-center items-center gap-4">
                ...
                <input
                  ...
                  className="w-[500px] h-5 font-inter font-medium text-sm leading-5 text-left text-circle-primary/35 placeholder-circle-primary/35 focus:outline-none"
                />
              </div>
            </div>
            ...
            <div className="flex flex-row justify-between items-center bg-white border border-circle-neutral-variant rounded-[25px] w-[240px] h-[30px] px-1.5">
              <div className="flex flex-row justify-center items-center gap-4">
                <span className="h-5 font-inter font-medium text-sm leading-5 text-circle-primary/35 pl-[10px]">
