...
export const COMMITMENT_GALLERY_HEIGHT_EXPANDED_DESKTOP = '210px'; // Desktop (≥ 640px)
export const COMMITMENT_GALLERY_HEIGHT_COLLAPSED_MOBILE = '45px';  // Mobile (< 640px)
export const COMMITMENT_GALLERY_HEIGHT_COLLAPSED_DESKTOP = '50px'; // Desktop (≥ 640px)
